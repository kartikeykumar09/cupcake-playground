...
const Footer = () => {
  return (
    <footer className="footer">
      ...
      <a href="https://github.com/kartikeykumar09/cupcake-playground" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.5rem', color: 'var(--text-muted)', textDecoration: 'none', fontSize: '0.9rem' }}>
